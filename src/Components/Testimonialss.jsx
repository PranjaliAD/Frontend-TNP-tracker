        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                ...
                <div className="grid mb-8 lg:mb-12 lg:grid-cols-2">
                    <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b-4 border-opacity-50 border-gray-800 md:p-12 lg:border-r-4 lg:border-opacity-50 lg:border-gray-800 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b-4 border-opacity-50 border-gray-800 md:p-12 dark:bg-gray-800 dark:border-gray-700">
                        <blockquote className="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                    ...
                    <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b-4 border-opacity-50 border-gray-800 lg:border-b-0 md:p-12 lg:border-r-4 lg:border-opacity-50 lg:border-gray-800 dark:bg-gray-800 dark:border-gray-700">
                        <blockquote className="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
