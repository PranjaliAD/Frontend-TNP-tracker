...
const Credentials = () => {
  ...
  return (
    <div className='container1'>
      {studData && (
        <>
          <h2 className='name'>{studData.student.name} </h2>
          <div className="reg">
            <h2 className='reg_id'>Registration Id:  {studData.student.regId}</h2>
            <h2 className='prn_no'>PRN no.:  {studData.student.prnNo}</h2>
          </div>
          <hr />
          <p className='description'>Description: {studData.student.instructoremailId}</p>
          <hr />
          <div className="mail-no">
            <div className="item1">
              <h4 className='h'>Email: </h4> <p className='p'>{studData.student.studentemailId}</p>
            </div>
            <div className="vertical-line"></div>
            <div className="item1">
              <h4 className='h'>Contact No.: </h4> <p className='p'>{studData.student.contactNumber}</p>
            </div>
          </div>
          <hr />
