  ...
  return (
    <div className="flex justify-center items-center">
      <form className="max-w-sm mx-auto border border-gray-300 p-4 rounded-lg">
        ...
        <div className="mb-5">
          <label htmlFor="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Position</label>
