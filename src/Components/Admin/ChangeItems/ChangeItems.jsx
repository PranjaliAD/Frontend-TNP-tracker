...
//   };
//   const toggleUploadCsvCoordinator = () => {
//     setIsUploadCsvCoordinatorsVisible(!isUploadCsvCoordinatorsVisible);
//   };
...
//           </dt>
//           <button onClick={toggleUploadCsvCoordinator} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded text-xs">
//             Click here
//           </button>
//         </div>
...
//         </div>
//       )}
//       {isUploadCsvCoordinatorsVisible && (
//         <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
//           <div className="bg-white p-6 rounded-lg shadow-lg">
//             <input type="file" onChange={handleFileUpload} />
//             <button onClick={toggleUploadCsvAdmin} className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded text-xs">
  ...
  return (
    <>
      ...
      {isUploadCsvCoordinatorsVisible && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <UploadCsvCoordinatorsForm />
            <button onClick={toggleUploadCsvCoordinator} className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded text-xs">
              Close
            </button>
          </div>
        </div>
